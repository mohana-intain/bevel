...
{% endif %}
    ...
    vault:
      ...
      secretpeer: {{ vault.secret_path | default('secret') }}/data/crypto/{{ component_type }}Organizations/{{ component_name }}/peers
      ...
      secretcouchdb: {{ vault.secret_path | default('secret') }}/data/credentials/{{ component_name }}/couchdb/{{ org_name }}
